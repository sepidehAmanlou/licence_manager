...
bankTestController  -  وظیفه دارد سه تراکنش آخر از دو سرویس شبیه‌سازی شده بانک ملت و سامان را از طریق کلاس‌های MellatBank و SamanBank دریافت و در خروجی JSON استاندارد بازگرداند.


در صورت بروز خطا (مثل عدم دریافت توکن یا تراکنش)، یک پیام خطای مناسب همراه با status = 500 و لاگ‌کردن خطا در فایل storage/logs/laravel.log انجام می‌شود.
